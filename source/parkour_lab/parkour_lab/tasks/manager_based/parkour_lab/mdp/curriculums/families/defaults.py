...
def build_default_families() -> tuple[ParkourFamilyCfg, ...]:
    ...
    return (
        ParkourFamilyCfg(name="gap", levels=gap.build_default_levels()),
        ParkourFamilyCfg(name="high_step", levels=high_step.build_default_levels()),
        ParkourFamilyCfg(name="hurdle", levels=hurdle.build_default_levels()),
        ParkourFamilyCfg(
            name="tilted_ramps",
